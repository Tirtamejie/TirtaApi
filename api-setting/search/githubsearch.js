...
async function githubSearch(query) {
  try {
    ...
    const res = await axios.get(searchUrl, {
      headers: {
        // Menggunakan header yang mirip dengan contoh Anda, disesuaikan untuk GitHub
        'Accept': 'application/vnd.github.v3+json',
        'User-Agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Mobile Safari/537.36',
        'Referer': 'https://github.com/', // Referer yang relevan
        'Accept-Encoding': 'gzip, deflate, br'
        // Tidak ada 'Authorization' karena tidak menggunakan API key
        // Tidak ada 'Content-Type' karena ini adalah permintaan GET
      }
    });
